...
public class Carrito extends Activity {
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        listado.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, android.view.View view, int posicion, long id) {
                Toast toast = Toast.makeText(Carrito.this, "Coordenada: " + posicion, Toast.LENGTH_LONG);
                toast.show();
            }
        });
        findViewById(R.id.imageButton21).setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void Listar() {
        ...
        if (base != null) {
            android.database.Cursor c = base.rawQuery("select * from item where pedido==" + Global.ivar1, null);
            ...
            listado = (android.widget.ListView) findViewById(R.id.Pedidos);
    ...
    public void osdo(android.view.View view) {
          toas();
        try {
           do{
               cc++;
